pipeline {
    ...
    stages {
        ...
        stage ('nexus') {
            steps {
                nexusArtifactUploader artifacts: [[artifactId: 'whatsapp', classifier: '', file: '/target/simple-web-app.war', type: 'war']], credentialsId: '5a0af56a-1fa8-49a1-8d5f-bc059281da43', groupId: 'practise', nexusUrl: '52.66.198.195', nexusVersion: 'nexus3', protocol: 'http', repository: 'suresh_release', version: '1.0.0'
            }
        }
    }
    post {
